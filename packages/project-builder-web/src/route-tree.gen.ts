...
import { Route as PluginsRouteRouteImport } from './pages/plugins/route'
import { Route as DataRouteRouteImport } from './pages/data/route'
import { Route as AppsRouteRouteImport } from './pages/apps/route'
import { Route as IndexRouteImport } from './pages/index'
import { Route as SettingsIndexRouteImport } from './pages/settings/index'
import { Route as PluginsIndexRouteImport } from './pages/plugins/index'
import { Route as DataIndexRouteImport } from './pages/data/index'
import { Route as AppsIndexRouteImport } from './pages/apps/index'
import { Route as SettingsThemeBuilderRouteImport } from './pages/settings/theme-builder'
import { Route as SettingsTemplateExtractorRouteImport } from './pages/settings/template-extractor'
import { Route as SettingsHierarchyRouteImport } from './pages/settings/hierarchy'
import { Route as DataModelsRouteRouteImport } from './pages/data/models/route'
import { Route as DataEnumsRouteRouteImport } from './pages/data/enums/route'
import { Route as DataModelsIndexRouteImport } from './pages/data/models/index'
import { Route as DataEnumsIndexRouteImport } from './pages/data/enums/index'
import { Route as PluginsEditIdRouteImport } from './pages/plugins/edit.$id'
import { Route as AppsEditKeyRouteRouteImport } from './pages/apps/edit.$key/route'
import { Route as AppsEditKeyIndexRouteImport } from './pages/apps/edit.$key/index'
import { Route as AppsEditKeyWebRouteImport } from './pages/apps/edit.$key/web'
import { Route as AppsEditKeyBackendRouteImport } from './pages/apps/edit.$key/backend'
import { Route as DataModelsEditKeyRouteRouteImport } from './pages/data/models/edit.$key/route'
import { Route as DataEnumsEditKeyRouteRouteImport } from './pages/data/enums/edit.$key/route'
import { Route as AppsEditKeyAdminRouteRouteImport } from './pages/apps/edit.$key/admin/route'
import { Route as DataModelsEditKeyIndexRouteImport } from './pages/data/models/edit.$key/index'
import { Route as DataEnumsEditKeyIndexRouteImport } from './pages/data/enums/edit.$key/index'
import { Route as AppsEditKeyAdminIndexRouteImport } from './pages/apps/edit.$key/admin/index'
import { Route as DataModelsEditKeyServiceRouteImport } from './pages/data/models/edit.$key/service'
import { Route as DataModelsEditKeyGraphqlRouteImport } from './pages/data/models/edit.$key/graphql'
import { Route as AppsEditKeyAdminSectionsRouteImport } from './pages/apps/edit.$key/admin/sections'
import { Route as AppsEditKeyAdminSectionsSectionKeyRouteImport } from './pages/apps/edit.$key/admin/sections.$sectionKey'
