    ...
    execute: async (builder) => {
      ...
      const templateMetadata: TsTemplateOutputTemplateMetadata | undefined = {
        ...
        template:
          'path' in template.source
            ? // TODO[2025-06-16]: Remove this once we've migrated all TS templates.
        ...
        projectExports:
          Object.keys(template.projectExports ?? {}).length > 0
            ...
            : undefined,
        // TODO[2025-06-16]: Remove casting once we've migrated all TS templates.
      ...
      const shouldIncludeMetadata =
        ...
        builder.metadataOptions.shouldGenerateMetadata({
          ...
          // TODO[2025-06-16]: Turn this into a file options === 'kind'
          isInstance: !!id,
        });
