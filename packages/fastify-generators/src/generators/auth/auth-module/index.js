...
exports.authModuleProvider = void 0;
...
exports.authModuleProvider = (0, sync_1.createProviderType)('auth-module');
var AuthModuleGenerator = (0, sync_1.createGeneratorWithChildren)({
    descriptorSchema: descriptorSchema,
    getDefaultChildGenerators: function (descriptor) { return ({
        service: {
            defaultDescriptor: {
    ...
    dependencies: {},
    exports: {
        authModule: exports.authModuleProvider
    },
...
exports["default"] = AuthModuleGenerator;
