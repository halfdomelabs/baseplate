...
exports.passwordHasherServiceProvider = void 0;
...
exports.passwordHasherServiceProvider = (0, sync_1.createProviderType)('password-hasher-service');
var PasswordHasherServiceGenerator = (0, sync_1.createGeneratorWithChildren)({
    ...
    exports: {
        passwordHasherService: exports.passwordHasherServiceProvider
    },
    createGenerator: function (descriptor, _a) {
        var _this = this;
        var node = _a.node, appModule = _a.appModule;
                ...
                passwordHasherService: {
                    getImportMap: function () { return ({
                        '%password-hasher-service': {
                            path: "@/".concat(moduleFolder, "/services/hasher-service"),
...
exports["default"] = PasswordHasherServiceGenerator;
