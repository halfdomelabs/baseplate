...
var pothos_auth_1 = require("../pothos-auth");
var descriptorSchema = pothos_auth_1.pothosAuthorizeConfigSchema;
var createMainTask = (0, sync_1.createTaskConfigBuilder)(function (descriptor) { return ({
    name: 'main',
    dependencies: {
        pothosAuth: pothos_auth_1.pothosAuthProvider,
        pothosType: pothos_field_1.pothosFieldProvider
    },
    run: function (_a) {
        var _this = this;
        var pothosAuth = _a.pothosAuth, pothosType = _a.pothosType;
...
var PothosAuthorizeFieldGenerator = (0, sync_1.createGeneratorWithTasks)({
...
exports["default"] = PothosAuthorizeFieldGenerator;
