...
exports.createPothosTypesFileTask = exports.pothosTypesFileProvider = void 0;
...
exports.pothosTypesFileProvider = (0, sync_1.createProviderType)('pothos-types-file');
exports.createPothosTypesFileTask = (0, sync_1.createTaskConfigBuilder)(function (_a) {
    var fileName = _a.fileName, categoryOrder = _a.categoryOrder;
    return ({
        ...
        exports: {
            pothosTypes: exports.pothosTypesFileProvider
        },
        run: function (_a) {
            var _this = this;
            var appModule = _a.appModule, typescript = _a.typescript, pothosSchema = _a.pothosSchema;
            var _b = (0, core_generators_1.makeImportAndFilePath)("".concat(appModule.getModuleFolder(), "/schema/").concat(fileName, ".ts")), typesImport = _b[0], typesPath = _b[1];
            ...
            return {
                getProviders: function () { return ({
                    pothosTypes: {
                        ...
                        getModuleName: function () { return typesImport; },
...
var PothosTypesFileGenerator = (0, sync_1.createGeneratorWithTasks)({
    descriptorSchema: descriptorSchema,
    getDefaultChildGenerators: function () { return ({}); },
    buildTasks: function (taskBuilder, descriptor) {
        taskBuilder.addTask((0, exports.createPothosTypesFileTask)(descriptor));
    }
});
exports["default"] = PothosTypesFileGenerator;
