...
var nexus_auth_1 = require("../nexus-auth");
var descriptorSchema = nexus_auth_1.authorizeConfigSchema;
var NexusAuthorizeFieldGenerator = (0, sync_1.createGeneratorWithChildren)({
    ...
    createGenerator: function (descriptor, _a) {
        var _this = this;
        var nexusAuth = _a.nexusAuth, nexusType = _a.nexusType;
        nexusType.addCustomField('authorize', nexusAuth.formatAuthorizeConfig(descriptor));
        return {
...
exports["default"] = NexusAuthorizeFieldGenerator;
