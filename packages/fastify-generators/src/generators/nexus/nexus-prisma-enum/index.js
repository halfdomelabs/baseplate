...
var ENUM_TYPE_TEMPLATE = "\nexport const ENUM_TYPE_EXPORT = enumType(ENUM_OPTIONS);\n".trim();
var NexusPrismaEnumGenerator = (0, sync_1.createGeneratorWithChildren)({
    ...
    createGenerator: function (_a, _b) {
        ...
        var nexusBlock = core_generators_1.TypescriptCodeUtils.formatBlock(ENUM_TYPE_TEMPLATE, {
            ENUM_TYPE_EXPORT: "".concat(enumName, "Enum"),
            ENUM_OPTIONS: core_generators_1.TypescriptCodeUtils.mergeExpressionsAsObject({
                name: (0, core_generators_1.quot)(enumName),
                members: core_generators_1.TypescriptCodeUtils.mergeExpressionsAsArray(enumBlock.values.map(function (value) {
                    return core_generators_1.TypescriptCodeUtils.mergeExpressionsAsObject({
                        name: (0, core_generators_1.quot)(value.name)
                    });
                }))
            })
...
exports["default"] = NexusPrismaEnumGenerator;
