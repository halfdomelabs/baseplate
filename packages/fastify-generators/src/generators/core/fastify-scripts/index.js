...
exports.fastifyScriptsProvider = void 0;
...
exports.fastifyScriptsProvider = (0, sync_1.createProviderType)('fastify-scripts');
var createMainTask = (0, sync_1.createTaskConfigBuilder)(function () { return ({
    ...
    exports: {
        fastifyScripts: exports.fastifyScriptsProvider
    },
    run: function (_a) {
        var _this = this;
        var node = _a.node, fastifyOutput = _a.fastifyOutput, eslint = _a.eslint;
        eslint
            .getConfig()
            .appendUnique('extraTsconfigProjects', ['./scripts/tsconfig.json']);
        node.addScripts({
            'run:script': "ts-node --transpile-only ".concat(fastifyOutput.getDevLoaderString()),
            'dev:script': "ts-node-dev --rs --transpile-only --respawn ".concat(fastifyOutput.getDevLoaderString())
        });
        return {
            ...
            build: function (builder) { return __awaiter(_this, void 0, void 0, function () {
                return __generator(this, function (_a) {
                    switch (_a.label) {
                        case 0: return [4 /*yield*/, builder.apply((0, sync_1.copyFileAction)({
...
var FastifyScriptsGenerator = (0, sync_1.createGeneratorWithTasks)({
...
exports["default"] = FastifyScriptsGenerator;
