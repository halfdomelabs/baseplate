...
exports.stripeEventService = void 0;
...
exports.stripeEventService = {
    registerHandler: function (type, handler) {
        if (eventHandlers[type]) {
            throw new Error("Handler for ".concat(type, " already registered"));
        }
        eventHandlers[type] = handler;
    },
    handleStripeEvent: function (event) {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        if (!handler) {
                            _logger_service_1.logger.info("No handler registered for event type ".concat(event.type));
                            return [2 /*return*/];
                        }
