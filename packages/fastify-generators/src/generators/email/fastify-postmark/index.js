...
exports.fastifyPostmarkProvider = void 0;
...
exports.fastifyPostmarkProvider = (0, sync_1.createProviderType)('fastify-postmark');
var createMainTask = (0, sync_1.createTaskConfigBuilder)(function () { return ({
    ...
    exports: {
        fastifyPostmark: exports.fastifyPostmarkProvider
    },
    run: function (_a) {
        var _this = this;
        var node = _a.node, typescript = _a.typescript, configService = _a.configService;
        node.addPackages({
            postmark: '3.0.12'
        });
...
var FastifyPostmarkGenerator = (0, sync_1.createGeneratorWithTasks)({
...
exports["default"] = FastifyPostmarkGenerator;
