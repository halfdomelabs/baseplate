...
var descriptorSchema = zod_1.z.object({
    createdAt: zod_1.z.boolean()["default"](true),
    updatedAt: zod_1.z.boolean()["default"](true)
});
var PrismaTimestampFieldsGenerator = (0, sync_1.createGeneratorWithChildren)({
    ...
    createGenerator: function (_a, _b) {
        var _this = this;
        var createdAt = _a.createdAt, updatedAt = _a.updatedAt;
        var prismaModel = _b.prismaModel;
        if (createdAt) {
...
exports["default"] = PrismaTimestampFieldsGenerator;
