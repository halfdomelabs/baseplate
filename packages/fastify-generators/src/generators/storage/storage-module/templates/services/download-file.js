...
function downloadFile(fileIdOrFile, context) {
    return __awaiter(this, void 0, void 0, function () {
        var file, _a, category, isAuthorizedToRead, _b, adapter;
        return __generator(this, function (_c) {
            switch (_c.label) {
                case 0:
                    if (!(typeof fileIdOrFile === 'string')) return [3 /*break*/, 2];
                    return [4 /*yield*/, FILE_MODEL.findUniqueOrThrow({
                ...
                case 5:
                    ...
                    if (!adapter.downloadFile) {
                        throw new Error("Storage adapter ".concat(file.adapter, " does not support downloading"));
                    }
                    return [2 /*return*/, adapter.downloadFile(file.path)];
            }
        });
    });
}
