...
exports.fastifyJestProvider = void 0;
...
exports.fastifyJestProvider = (0, sync_1.createProviderType)('fastify-jest');
var FastifyJestGenerator = (0, sync_1.createGeneratorWithChildren)({
    ...
    exports: {
        fastifyJest: exports.fastifyJestProvider
    },
    createGenerator: function (descriptor, _a) {
        var _this = this;
        var jest = _a.jest, node = _a.node;
        // add config to jest setup
        jest
            .getConfig()
            .appendUnique('customSetupBlocks', [
            core_generators_1.TypescriptCodeUtils.createBlock('config()', "import { config } from 'dotenv'"),
        ]);
...
exports["default"] = FastifyJestGenerator;
