    ...
    return tasks.map((task) => {
      ...
      return {
        ...
        run(dependencies) {
          ...
          // eslint-disable-next-line @typescript-eslint/no-unnecessary-condition -- bug in null/undefined detection since it can be undefined
  ...
  return {
    createGenerator: (descriptor, context) => {
      ...
      return {
        ...
        directory: context.generatorBaseDirectory,
      };
    },
  };
}
