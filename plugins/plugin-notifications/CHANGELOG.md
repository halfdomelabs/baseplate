...
- [#1040](https://github.com/halfdomelabs/baseplate/pull/1040) [`6a5a1bf`](https://github.com/halfdomelabs/baseplate/commit/6a5a1bfe71e75e2bce938a89d9c2860f8a9ee213) Thanks [@kingston](https://github.com/kingston)! - Notification emails now carry one-click `List-Unsubscribe` headers, backed by a signed endpoint that turns email off for the topics that email covered; a notification belonging to no topic carries no header, since the user cannot switch it off.
