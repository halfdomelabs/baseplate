    ...
    return {
      providers: {
        queuesImports: createTsImportMap(queuesImportsSchema, {
          ...
          hasFinalAttemptFailureHandler: paths.queueTypes,
          QueueFinalAttemptFailureHandler: paths.queueTypes,
          ...
          QueuePolicyFixPlan: paths.queueTypes,
          QueuePolicyFixResult: paths.queueTypes,
