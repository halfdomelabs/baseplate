...
import { BETTER_AUTH_ADMIN_ADMIN_CRUD_RESET_PASSWORD_ACTION_GENERATED as GENERATED_TEMPLATES } from './generated/index.js';
...
/**
 * Generator for better-auth/admin/admin-crud-reset-password-action
 */
export const adminCrudResetPasswordActionGenerator = createGenerator({
  name: 'better-auth/admin/admin-crud-reset-password-action',
