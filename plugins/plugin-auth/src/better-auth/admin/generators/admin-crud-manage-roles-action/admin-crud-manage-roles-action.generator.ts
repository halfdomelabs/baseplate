...
import { BETTER_AUTH_ADMIN_ADMIN_CRUD_MANAGE_ROLES_ACTION_GENERATED as GENERATED_TEMPLATES } from './generated/index.js';
...
export const adminCrudManageRolesActionGenerator = createGenerator({
  name: 'better-auth/admin/admin-crud-manage-roles-action',
