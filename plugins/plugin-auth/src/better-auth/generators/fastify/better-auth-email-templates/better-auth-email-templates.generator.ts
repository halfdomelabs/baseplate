...
import { BETTER_AUTH_BETTER_AUTH_EMAIL_TEMPLATES_GENERATED as GENERATED_TEMPLATES } from './generated/index.js';

const descriptorSchema = z.object({});

/**
 * Generator for better-auth email templates.
 *
 ...
 */
export const betterAuthEmailTemplatesGenerator = createGenerator({
  name: 'better-auth/better-auth-email-templates',
