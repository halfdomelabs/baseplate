...
- [#1040](https://github.com/halfdomelabs/baseplate/pull/1040) [`6a5a1bf`](https://github.com/halfdomelabs/baseplate/commit/6a5a1bfe71e75e2bce938a89d9c2860f8a9ee213) Thanks [@kingston](https://github.com/kingston)! - Backends now generate an in-memory email adapter, so a test can assert on the message a provider would have received — its rendered subject, body and headers — instead of mocking the send call.
