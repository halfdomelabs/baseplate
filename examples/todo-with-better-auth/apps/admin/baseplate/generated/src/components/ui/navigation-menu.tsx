...
function NavigationMenuTrigger({
  ...
  return (
    ...
    >
      {children}{' '}
      <MdExpandMore
        className="relative top-px ml-1 size-3 transition duration-300 group-data-open:rotate-180 group-data-popup-open:rotate-180"
        aria-hidden="true"
      />
    </NavigationMenuPrimitive.Trigger>
  );
