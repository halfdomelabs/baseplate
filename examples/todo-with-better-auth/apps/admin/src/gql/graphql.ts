...
export type PasswordResetDialog_UserFragment = { __typename?: 'User', id: string, name: string, email: string } & { ' $fragmentName'?: 'PasswordResetDialog_UserFragment' };
...
export type RoleManagerDialog_UserFragment = { __typename?: 'User', id: string, name: string, email: string, roles: Array<{ __typename?: 'UserRole', role: string }> } & { ' $fragmentName'?: 'RoleManagerDialog_UserFragment' };
