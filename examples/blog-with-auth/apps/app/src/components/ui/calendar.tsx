 ...
 *
 * ShadCN changes:
 * - Paints `bg-panel-background` instead of `bg-background` plus per-container
 *   `bg-transparent` overrides, so it inherits the surface it is dropped onto
 *
...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        'group/calendar bg-panel-background p-2 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(7)]',
      ...
      components={{
        ...
        Chevron: ({ className, orientation, ...props }) => {
          ...
          if (orientation === 'right') {
            return (
              <MdChevronRight className={cn('size-4', className)} {...props} />
            );
          }
