...
import type {
  ...
  RateLimiterConfig,
  RateLimitResult,
} from '../types/rate-limiter.types.js';

import { TooManyRequestsError } from '../utils/http-errors.js';
 ...
 * Uses Redis as the primary limiter with Prisma as an insurance fallback.
 * If Redis fails, the insurance limiter catches the request.
 *
