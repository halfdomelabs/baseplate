...
This file provides guidance to AI agents working with the **blog-with-auth** project.

## Project Overview

blog-with-auth is a full-stack TypeScript monorepo built with [Baseplate](https://www.baseplate.dev).
